...
<div align="center">
  <h1><b>Torre technical test proxy</b></h1>
  </br>
...
This is an API to be used by the technical test project for Torre. Its purpose is to organize data and bypass the CORS.
...
- **Bypass CORS**
- **Organize data obtained using the API provided by Torre**
...
- [Live](https://proxy-torre.fly.dev/api/bios/davidtamayo1112)
...
```sh
  git git@github.com:IngDavidTM/proxy-cors-api.git
  cd proxy-cors-api
```
